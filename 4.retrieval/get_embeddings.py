...
data_file_path = f"../data/check_result_relation_summary_jsonl/{data_name}/result_{doc_name}_{data_name}_relation_summary_{range_tag}.jsonl"

data_jsonl_data = read_jsonl(data_file_path)
print(f"{data_file_path} loading successful")

embeddings_file_path = f"../data/get_embeddings/{doc_name}_{data_name}_embeddings_{range_tag}.npy"
