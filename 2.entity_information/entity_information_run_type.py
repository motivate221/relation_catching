...
for id in range(start, end):
    ...
    if save_cnt == 200:
        ...
        save_name = f"../data/entity_information_run/{data_name}/result_{doc_name}_{data_name}_entity_information-type_{save_id}.jsonl"
...
if len(prompt_list) > 0:
    ...
    save_name = f"../data/entity_information_run/{data_name}/result_docred_{data_name}_entity_information-type_{save_id}.jsonl"
    save_to_jsonl(save_data_list, save_name)
    print(f"The result is saved in the file {save_name}")
    save_id += 1
    save_cnt = 0
